...
Build the Admin UI in `@assisted-to-agentic-module-1/config-service/ui/`
(sibling to `src/`), using the stack and reasoning already recorded in
`@assisted-to-agentic-module-1/config-service/context/IMPLEMENTATION.md`.
...
on the service (`@assisted-to-agentic-module-1/config-service/src/ConfigApi.Service/Program.cs`)
